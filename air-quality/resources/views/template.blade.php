...
<body>
    ...
    <div class="container-fluid">
        <nav class=" navbar-expand-lg navbar-dark">
            <ul class="nav  nav-tabs justify-content-center align-content-center flex-wrap ">
                <li class="order-sm-0 nav-item rounded"><a class="nav-link" href="{{ url('/') }}">Home</a></li>
                <li class="order-sm-1 nav-item rounded"> <a class="nav-link" href="{{ url('/team') }}">Our team</a></li>
                <li class="order-sm-2 nav-item rounded"><a class="nav-link disabled" href="{{ url('/about') }}">About FAQ</a></li>
