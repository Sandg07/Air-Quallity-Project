<nav class="navbar navbar-expand-lg d-flex py-3 flex-row-lg-fluid  bg-info p-2 px-5">
    ...
    <span>
        <img src="/assets/logo/logo_letzbreathe_whitecyan.png" width="120px" height="80px" alt="Letz Breathe logo">
    </span>
    ...
    <div class="collapse navbar-collapse justify-content-end px-9" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
                ...
                <a class="order-sm-0 nav-link p-2 " href="{{ url('/dashboard') }}"><svg
            ...
            <li>
                <a class="order-sm-1 nav-link p-2" href="{{ url('/forecast') }}"><svg
