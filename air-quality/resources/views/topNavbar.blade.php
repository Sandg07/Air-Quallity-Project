...
{{-- <div class="top-navbar navbar navbar-expand-lg "> --}}

<nav class="navbar navbar-expand-sm bg-info p-4" >
    <span class="logo-nav navbar-brand mb-0 h1" style="color: white">Lëtz Breathe
        
    </span>
<button class="navbar-toggler" type="button"  data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" id="test" class="bi bi-list text-primary" viewBox="0 0 16 16">
