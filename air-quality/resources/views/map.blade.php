...
<body>
    ...
    <div class="charts-map-favorite-container container container-fluid col-12">

        <div class="charts-container row justify-content-md-center">
            <div id="chartContainer1" class="bar-chart-container col-md-8 m-2" style="height: 150px"></div>
            <div id="carChartContainer1" class="car-chart-container col m-2" style="height: 150px"></div>
        </div>


        <div class="map-favorite-container h-100 p-0 m-0 row justify-content-md-around">
